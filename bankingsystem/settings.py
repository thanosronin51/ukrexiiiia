...
BASE_DIR = Path(__file__).resolve().p
import os
from pathlib import Path
...
DATABASES = {
    'default': {
        ...
        'HOST': 'db.kkzyqggnrbhxbhdstcqk.supabase.co',
        'PORT': '6543',
    }
}
...
DEFAULT_FILE_STORAGE = 'cloudinary_storage.storage.MediaCloudinaryStorage'arent.parent
